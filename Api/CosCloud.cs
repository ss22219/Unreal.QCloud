...
using System.Linq;
using System.Text;
using Unreal.QCloud.Common;
using Unreal.QCloud.Util;
using System.Web;
using System.IO;
using Unreal.QCloud;
...
namespace Unreal.QCloud.Api
{
    public class CosCloud
    {
        ...
        {
            string url = cosApiUrl + this.appId + "/" + bucketName + HttpUtils.EncodeRemotePath(remotePath);
            return url;
        }
        ...
        {
            string url = cosApiUrl + this.appId + "/" + bucketName + HttpUtils.EncodeRemotePath(remotePath) + HttpUtility.UrlEncode(prefix);
            return url;
        }
